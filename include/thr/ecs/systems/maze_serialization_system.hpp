/**
 * @file maze_serialization_system.hpp
...
#ifndef THR_ECS_SYSTEMS_MAZE_SERIALIZATION_HPP
#define THR_ECS_SYSTEMS_MAZE_SERIALIZATION_HPP
...
namespace thr::ecs {
     ...
     */
    class maze_serialization_system {
      public:
        /**
         * @brief 将迷宫序列化为 JSON。
...
#endif // THR_ECS_SYSTEMS_MAZE_SERIALIZATION_HPP