...
namespace thr::ecs {
    ...
    class scene_system {
      public:
         ...
         */
        static bool insert_scene(entt::registry &registry, scene_identifier_type scene_id);
        /**
         * @brief 删除一个场景实体。
         * @param [in] registry 注册表。
         * @param [in] scene_id 场景id。
         ...
         */
        static bool erase_scene(entt::registry &registry, scene_identifier_type scene_id);
        /**
         * @brief 清除所有的场景实体
         * @param [in] registry 注册表
         * @warning 此函数不会删除场景的子实体，需要手动删除
         */
        static void clear_scenes(entt::registry &registry);
        /**
         * @brief 获取所有场景实体的列表。
         * @param [in] registry 注册表。
        ...
        get_scenes(entt::registry &registry);
        /**
         * @brief 将子实体加入场景中。
         * @param [in] registry 注册表。
         * @param [in] scene_id 场景id。
         ...
         * @param [in] child_entity 子实体。
         */
        static void erase_from_all_scenes(entt::registry &registry, entt::entity child_entity);
        /**
         * @brief 获取场景所有孩子的集合
         * @param [in] registry 注册表
         * @param [in] scene_id 场景id。
        ...
        get_scene_children(entt::registry &registry, scene_identifier_type scene_id);
        /**
         * @brief 获取子实体所有父场景的集合。
         * @param [in] registry 注册表。
         * @param [in] child_entity 子实体。
        ...
        get_father_scenes(entt::registry &registry, entt::entity child_entity);
        ...
        get_entities_in_same_scene(entt::registry &registry, entt::entity entity) {
